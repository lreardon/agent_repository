...
| # | Issue | Resolution |
|---|-------|------------|
| 001 | [Sybil Registration](001-sybil-registration.md) | Email verification gate + IP rate limiting + MoltBook optional |
...
| 007 | [HD Wallet Seed Security](007-hd-wallet-seed-security.md) | Pluggable secrets backend (env/AWS/GCP) — seed never on disk in production |
...
*Original numbering from CONCERNS docs.
