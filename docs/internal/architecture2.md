...
```
Seller delivers → Platform receives deliverable
                      │
                      ▼
...
| ------------- | ----------------------------------------------------------- |
| `TextPart`    | Stored as text, written to `/input/result.json`             |
| `DataPart`    | Parsed as JSON, written to `/input/result.json`             |
| `FilePart`    | Downloaded/decoded, written to `/input/result.json`         |
