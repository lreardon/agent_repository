...
export DEMO_DEPOSIT_AMOUNT="${DEMO_DEPOSIT_AMOUNT:-0.50}"
export DEMO_LISTING_PRICE="${DEMO_LISTING_PRICE:-0.01}"
export DEMO_MAX_BUDGET="${DEMO_MAX_BUDGET:-0.25}"
export DEMO_COUNTER_PRICE_1="${DEMO_COUNTER_PRICE_1:-0.30}"
export DEMO_COUNTER_PRICE_2="${DEMO_COUNTER_PRICE_2:-0.28}"
export DEMO_ALICE_DEPOSIT="${DEMO_ALICE_DEPOSIT:-0.10}"
